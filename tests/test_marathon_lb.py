...
frontend nginx_net
  mode http
  bind abns@nginx_net accept-proxy ssl crt /tmp/cert.pem
  acl path_letsencrypt_10002 path_beg /.well-known/acme-challenge
  use_backend letsencrypt_10002 \
...
frontend server_nginx_net
  mode http
  bind abns@server_nginx_net accept-proxy ssl crt /tmp/cert.pem
  acl path_letsencrypt_10002 path_beg /.well-known/acme-challenge
  use_backend letsencrypt_10002 \
...
frontend server3_nginx_net
  mode http
  bind abns@server3_nginx_net accept-proxy ssl crt /tmp/cert.pem
